...
<<<<<<< HEAD
	 ...
	 * 
	 * @param uid,password the two things to search fby
=======
	 * @param p
	 *            the person to add
	 * @return a long. -1 if error
...
<<<<<<< HEAD
     ...
     */
	 ...
	 /**
	     * Returns the number of Login Attempts by a user. Used to determine if that user is locked or not.
	     * 
	     * @param String u_name, name of user
	     */
	 
	 int getLoginAttempts(String u_name);
	 
	 /**
	     *Close the connection to database. Must make sure that it is already open before closing it.
	     * 
	     * @param none
	     * @return void
	     */ 
     ...
     * 
     * @param the new number of times the user has attempted to login. 
     */
     ...
     * 
     * @param the user id of the user to be locked
     */
	void setLocked(String u_name);
	 /**
     * This method returns the items that a user has.
     * 
     * @param item the item to add to the buffer
     */
	Item [] getItems(String current_user);
	/**
     * Makes the usr referenced by a uid, the current user
     * 
     * @param String the name of the usr
     */
     ...
     * 
     * @param String the uid to search by
     * @return boolean
     */
	boolean isAdmin(String uid);
	/**
     * A method that determines if there is already a user with uid and password.
     * Returns true if user exists; false otherwise.
     * 
     * @param String password, uid of user to search for
     *	@return boolean
     */
	...
	/**
     *  Set an Account to unlocked. Account can be locked or unlocked and method still works.
     * 
     ...
     * 
     * @param String uid of user to make admin
     *	@return boolean
     */
     ...
     * 
     * @param String uid of user and a key to know what kind of item we want to search
     *	@return array of Items of a kind key
     */
	Item[] getItems(String current_user, String key);

	/**
     *  Set an Account to locked. Account can be locked or unlocked and method still works.
     * 
     * @param String uid of user to unlock
     *	@return void
     */
     ...
     * 
     * @param String uid of user to remove
     *	@return an int
     */
	...
	/**
     *  determines if uid has a given password. Returns true if usr has given password; else false;
     * 
     * @param String uid of user and user's password
     *	@return boolean
     */
     ...
     * 
     * @param String kind of item to search (lost, etc), String refined_search filter
     *	@return Cursor
     */
     ...
     *  Saves Item to model. 
     * 
     * @param String name, description, status, int keep, heir, misc (what the item is), Long date,
     * String current user, street of user, zip code of user, String type (lost, found, etc).
     *	@return Cursor
     */
